...
const options = {
  ...
  contentGoal: [
    "Educate", "Entertain", "Inspire", "Build Trust", "Generate Discussion",
    "Tell a Story", "Build Personal Brand", "Generate Leads",
    "Sell a Product/Service", "Get Followers", "Drive Engagement",
    "Raise Awareness", "Explain / Simplify",
  ],
  hookType: [
    "AI Choice / Smart Mode", "Curiosity", "Problem", "Question", "Contrarian",
    "Bold Statement", "Story", "Shocking Fact", "Mistake", "Direct Benefit",
    "Fear / Risk", "Comparison", "Scenario",
  ],
  pacing: ["AI Optimized", "Slow", "Natural", "Medium", "Fast", "Rapid-fire"],
  ctaType: [
    "AI Choose", "None", "Follow", "Comment", "Share", "Save", "DM",
    "Visit Link", "Buy / Purchase", "Subscribe", "Ask a Question", "Soft CTA",
  ],
  visualStyle: [
    "AI Choose", "Talking Head", "B-roll Heavy", "Talking Head + B-roll",
    "Screen Recording", "Product Demo", "Cinematic", "Educational / Explainer",
    "Meme / Fast Cut", "Interview / Podcast",
  ],
  yesNo: ["Yes", "No"],
...
const defaults = {
  ...
  energy: "High",
  contentGoal: "Educate",
  hookType: "AI Choice / Smart Mode",
  pacing: "AI Optimized",
  ctaType: "AI Choose",
  visualStyle: "AI Choose",
          ...
          <>
            <section className="card">
              ...
              <div className="grid">
                ...
                <SelectField label="Content Goal" value={form.contentGoal} onChange={(v) => set("contentGoal", v)} items={options.contentGoal} />
                <SelectField label="Hook Type" value={form.hookType} onChange={(v) => set("hookType", v)} items={options.hookType} />
                <SelectField label="Pacing" value={form.pacing} onChange={(v) => set("pacing", v)} items={options.pacing} />
                <SelectField label="CTA Type" value={form.ctaType} onChange={(v) => set("ctaType", v)} items={options.ctaType} />
                <SelectField label="Visual Style" value={form.visualStyle} onChange={(v) => set("visualStyle", v)} items={options.visualStyle} />
